...
apipatterns = [
    ...
    path("license/", LicenseView.as_view(), name="api-license"),
    path("version-text", VersionTextView.as_view(), name="api-version-text"),
    ...
    path(
        ...
        include(
            [
                ...
                path(
                    "registration/", CustomRegisterView.as_view(), name="rest_register"
                ),
